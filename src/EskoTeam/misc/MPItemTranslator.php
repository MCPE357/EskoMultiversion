...
class MPItemTranslator
{
	...
	/**
	 * @param MPItemTypeDictionary $dictionary
	 ...
	 */
	public function __construct(MPItemTypeDictionary $dictionary, array $simpleMappings, array $complexMappings)
	{
	...
	private static function make(): self
	{
		...
		return new self(MPItemTypeDictionary::getInstance(), $simpleMappings, $complexMappings);
	}
